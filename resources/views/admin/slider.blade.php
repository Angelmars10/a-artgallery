<div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center">
          <div class="avatar"><img src="{{asset('admincss/img/favicon.JPG')}}" alt="..." class="img-fluid rounded-circle"></div>
          <div class="title">
            <h1 class="h5">Angelwin Marie</h1>
            <p>Art Manager</p>
          </div>
        </div>
        ...
        <ul class="list-unstyled">
                ...
                <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows">
                  ...
                  <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                    <li><a href="{{url('add_painting')}}">Add Painting</a></li>
                    <li><a href="{{url('view_painting')}}">View Painting</a></li>
                  </ul>
                </li>
