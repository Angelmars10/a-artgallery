...
<head>
  <meta charset="utf-8">
  <link rel="icon" type="image/png" href="images/A-ART.png"/>
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>A-Art Gallery-Registration</title>
      ...
      <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
        <div class="card border border-light-subtle rounded-3 shadow-sm">
          <div class="card-body p-3 p-md-4 p-xl-5">
            <div class="text-center mb-3">
              <a href="#!">
              <img src="images/A-ART.png"  width="250">
              </a>
            </div>
        ...
        @csrf
              ...
              <div class="row gy-2 overflow-hidden">
                ...
                <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" id="address" placeholder="name@example.com" required>
                ...
                <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="integer" class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" placeholder="name@example.com" required>
